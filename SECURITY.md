...
| Privilege escalation | Site-admin endpoints gated by `require_site_admin`; role changes are audited; the last site admin cannot be revoked and a class's last admin cannot be demoted (no lock-out, no orphaned classes) |
