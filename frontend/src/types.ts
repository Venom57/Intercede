...
export type GroupT = { id: string; name: string; role: string; status: string; invite_code: string | null };
...
export type QueueEntry = { membership_id: string; display_name: string; email: string; family: string | null };
export type AuditEntry = { id: string; action: string; actor_id: string | null; actor: string | null; target_id: string | null; detail: string | null; created_at: string };
